...
{
 public:
  NcAstrolab2(const char* name="User",const char* title="Virtual Lab for general use"); // Constructor
 ...
 ClassDef(NcAstrolab2,41) // Virtual lab to provide (astro)physical parameters, treat data and relate observations with astrophysical phenomena
};
#endif
